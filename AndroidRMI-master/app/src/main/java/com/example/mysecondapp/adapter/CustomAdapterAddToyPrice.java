...
public class CustomAdapterAddToyPrice extends RecyclerView.Adapter<CustomAdapterAddToyPrice.ViewHolder> {
    private List<Toy> toys;
    public CustomAdapterAddToyPrice(List<Toy> toys){
        this.toys = toys;
    }

    @Override
    public CustomAdapterAddToyPrice.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View rowItem = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_add_price, parent, false);
        return new ViewHolder(rowItem);
    }

    @Override
    public void onBindViewHolder(CustomAdapterAddToyPrice.ViewHolder holder, int position) {
